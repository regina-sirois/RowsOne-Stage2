...
T = TypeVar("T", bound="GetCompaniesResponse200DataMeta")


@_attrs_define
class GetCompaniesResponse200DataMeta:
    """
    Attributes:
        ...
        searchable_fields (list[str] | Unset): Fields that can be searched via the q parameter Example: ['name', 'ein'].
    """
    ...
    searchable_fields: list[str] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        searchable_fields: list[str] | Unset = UNSET
        if not isinstance(self.searchable_fields, Unset):
        ...
        if searchable_fields is not UNSET:
            field_dict["searchable_fields"] = searchable_fields
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        searchable_fields = cast(list[str], d.pop("searchable_fields", UNSET))

        get_companies_response_200_data_meta = cls(
        ...
        get_companies_response_200_data_meta.additional_properties = d
        return get_companies_response_200_data_meta
